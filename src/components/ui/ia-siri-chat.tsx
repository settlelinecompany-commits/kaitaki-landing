...
export function VoiceChat({
  ...
  return (
    <div className={cn("flex flex-col items-center justify-center w-full h-full bg-white relative overflow-hidden rounded-lg", className)}>
      {/* Ambient particles */}
      ...
      <div className="relative z-10 flex flex-col items-center space-y-4 py-4">
        ...
        <div className="text-center space-y-1">
          <motion.p
            className={cn("text-xs font-medium transition-colors", getStatusColor())}
        ...
        <div className="text-center mt-2">
          <p className="text-xs text-zinc-600">
            Hi, I'm Kiwa - I run your privacy voice assessment
          </p>
        </div>
      </div>
    </div>
