...
function PureSuggestedActions({
  ...
  const suggestedActions = [
    {
      ...
      action: 'Generate GAP assessment',
    },
    {
      title: 'Draft ROPA',
  ...
  return (
    <div
      ...
      className="grid pb-2 grid-cols-1 gap-2 w-full"
    >
      <AnimatePresence>
    ...
    <div className={cn("relative w-full flex flex-col gap-2", className)}>
      ...
      <div className="relative">
        <Textarea
          ...
          className={cn(
            'min-h-[60px] max-h-[120px] overflow-y-auto resize-none rounded-2xl !text-sm pb-10',
